...
wlAccuracy = wlAccuracy(toPlotInds);
graphletAccuracies = graphletAccuracies(:, toPlotInds);

wlRuntimes = wlRuntimes(toPlotInds);
graphletRuntimes = graphletRuntimes(:, toPlotInds);
...
loglog(sizesToPlot, stdTotalRuntimes, '--o', ...
    ...
    sizesToPlot, wlRuntimes, '--.', ...
    sizesToPlot, graphletRuntimes(end, :), '--x')
legend('Standard', ...
...
plot(sizesToPlot, stdAccuracy, '--+', ...
    ...
    sizesToPlot, wlAccuracy, '--.', ...
    sizesToPlot, graphletAccuracies(m2, :), '-->')
%xlim([0 ms(end)*1.1])
