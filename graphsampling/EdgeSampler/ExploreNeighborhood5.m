function [count, nodeSets] = ExploreNeighborhood5(A, L, i, j)
%EXPLORENEIGHBORHOOD5 Count the graphlets associated with edge (i,j)
%   Author: Otto
    ...
    for k=j+1:N-2
        for l=k+1:N-1
            for m=l+1:N % with this kind of enumeration we make sure
                ...
                if L{i}(j) == jj % consider sampled edge only                    
